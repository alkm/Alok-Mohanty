...
(function ($) {
            ...
            var whenLoaded = function (img) {
                ...
                var whenDimensions = function (width, height) {
                    ...
                    /*$img.css({left: leftOffset});
                     $img.css({top: topOffset});*/// Commented by alok to keep the slide at center for this app
    ...
    var RssPrivateMethods = {
        ...
        _setTimeout: function ($slideshow, interval) {
            ...
            if (interval <= data.settings.transition / 2000) {
                interval = (data.settings.transition / 2000) + 0.1;
            }
