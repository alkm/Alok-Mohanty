...
(function ($) {
    var methods = {init: function (options) {
        return this.each(function () {
            var slideshow = this, $slideshow = $(this), data = $slideshow.data('rsf_slideshow'), settings;
            if (!data) {
        ...
        return this.each(function () {
            var $slideshow = $(this), data = $slideshow.data('rsf_slideshow');
            if (data.interval_id) {
        ...
        var $slideshow = this, data = $slideshow.data('rsf_slideshow'), containerWidth = $slideshow.width(), containerHeight = $slideshow.height();
        ...
        var whenLoaded = function (img) {
            ...
            RssPrivateMethods._getImageDimensions($slideshow, $img, whenDimensions, (data.settings.interval * 1000) / 2, function () {
                whenDimensions();
            });
        };
        ...
        return this.each(function () {
            var $slideshow = $(this), settings = $slideshow.data('rsf_slideshow').settings;
    ...
    var RssPrivateMethods = {_findData: function ($slideData, slide_data_selectors) {
        var slide = {};
        var slide_attr;
        ...
        var data = $slideshow.data('rsf_slideshow'), effect_iteration = 'random', $prevSlide = $slideshow.find('.' + data.settings.slide_container_class + ':last');
        if ($prevSlide.length) {
        ...
        var data = $slideshow.data('rsf_slideshow'), $prevSlide = $slide.prev();
        $slide.css({top: top_offset, left: left_offset});
        $slide.css('display', 'block');
        $slide.stop().animate({top: 0, left: 0}, data.settings.transition, data.settings.easing, function () {
            RssPrivateMethods._endTransition($slideshow, $slide);
        });
        $prevSlide.stop().animate({top: (0 - top_offset), left: (0 - left_offset)}, data.settings.transition, data.settings.easing);
    ...
    $.rsfSlideshow = {defaults: {interval: 5, transition: 1000, effect: 'fade', easing: 'swing', loop: true, autostart: true, slides: [], slide_container_class: 'slide-container', slide_caption_class: 'slide-caption', data_container: 'ol.slides', slide_data_container: 'li', slide_data_selectors: {url: {selector: 'a', attr: 'href'}, caption: {selector: 'a', attr: 'title'}, link_to: {selector: 'a', attr: 'data-link-to'}, effect: {selector: 'a', attr: 'data-effect'}}, eventHandlers: {rsStartShow: function (rssObj, e) {
    ...
    }}, controls: {playPause: {generate: function ($slideshow) {
        ...
        var $container = $slideshow.data('rsf_slideshow').settings.controls.container.get($slideshow);
        $container.append($control);
    }, get: function ($slideshow) {
        return $('.rs-play-pause[data-control-for="' + $slideshow.attr('id') + '"]');
    }, playing_class: 'rs-playing', paused_class: 'rs-paused', auto: false}, previousSlide: {generate: function ($slideshow) {
    ...
    }, autostop: true, auto: false}, nextSlide: {generate: function ($slideshow) {
    ...
    }, autostop: true, auto: false}, index: {generate: function ($slideshow) {
        var slide_count = $slideshow.rsfSlideshow('totalSlides'), $indexControl = $('<ul class="rs-index-list clearfix"></ul>');
    ...
    }, active_class: 'rs-active', autostop: true, auto: false}, container: {generate: function ($slideshow) {
    ...
    }}}}, transitions: {none: function ($slideshow, $slide) {
        $slide.css('display', 'block');
    }, fade: function ($slideshow, $slide) {
        $slide.fadeIn($slideshow.data('rsf_slideshow').settings.transition, function () {
            RssPrivateMethods._endTransition($slideshow, $slide);
        });
